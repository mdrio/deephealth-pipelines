...
# airflow variables set SERIAL_PREDICTIONS_PARAMS '{ "slide": { "class": "File", "path": null }, "tissue-low-level": 9, "tissue-low-label": "tissue_low", "tissue-high-level": 4,  "tissue-high-label": "tissue_high", "tissue-high-filter": "tissue_low>0.1",   "gpu": [1, 2], "tumor-level": 1, "tumor-label": "tumor", "tumor-filter": "tissue_low>0.8" }'
